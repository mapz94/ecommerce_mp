<?php  
    ...
    if(isset($product["discount"])){
        $final_price = ($product["price"] - $product["discount"] * $product["price"]) * $product["q"];
    }
...
<div class="card" style="max-width: 400px">
    <div class="container">
        ...
        <h3 class="title">Cantidad:<?php echo $product["q"]  ?></h5>
        <h3 class="title">Precio total: $<?php echo number_format($final_price,0,',','.');  ?></h5>
        <div class="actions">
        <form method="post" class="container">
            <input hidden readonly type="text" name="action" value="removeCart" >
